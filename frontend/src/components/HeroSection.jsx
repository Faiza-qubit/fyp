      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12 lg:py-24">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            >
              Experience luxury footwear like never before. Try shoes virtually
              with our cutting-edge AR technology before making your perfect
              choice.
            </motion.p>
            ...
            >
              {[
                ...
                >
                  <p className="text-3xl font-bold bg-gradient-to-r from-primary to-yellow-400 bg-clip-text text-transparent group-hover:animate-pulse-glow">
                    {stat.value}
                  </p>
